    ...
    return (
        <div className={style.about}>
            ...
            <p className={style.text}>
                Somos una comunidad para compartir conocimiento de los últimos avances de React Js y cualquier derivado de React  Native, Redux, React-bootstrap, Material U-I y más.
            </p>
